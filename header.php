...
<head>
    ...
    <?php wp_enqueue_style("font-awesome","https://use.fontawesome.com/releases/v5.6.1/css/all.css");
          wp_enqueue_style('bistro-calme-min-css', get_template_directory_uri()."/assets/css/styles.min.css");
          wp_enqueue_script('jquery');
          wp_enqueue_script('bistro-calme-main-js',  get_template_directory_uri()."/assets/js/main.js");
          wp_head();?>
</head>
<body <?php body_class();?>>
  <?php wp_body_open();?>
